        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/events" className="text-gray-500 hover:text-gray-300 transition-colors text-sm">Events</Link></li>
          ...
          <div>
            ...
            <a href="mailto:prawmathean@proton.me" className="inline-flex items-center gap-1.5 text-indigo-400 hover:text-indigo-300 transition-colors text-sm font-medium">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/prajwal-56/ahaliaoverflow" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
              ...
              <a href="https://instagram.com/tinkerhub.aset" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-pink-400 transition-colors">
